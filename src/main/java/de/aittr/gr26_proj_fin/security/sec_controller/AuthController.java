package de.aittr.gr26_proj_fin.security.sec_controller;

import de.aittr.gr26_proj_fin.domain.CommonUser;
import de.aittr.gr26_proj_fin.security.sec_dto.RefreshRequestDto;
import de.aittr.gr26_proj_fin.security.sec_dto.TokenResponseDto;
import de.aittr.gr26_proj_fin.security.sec_service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<TokenResponseDto> login(
            @RequestBody @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Object of an user that logging in") CommonUser user,
